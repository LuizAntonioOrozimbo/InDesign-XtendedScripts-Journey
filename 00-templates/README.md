# Templates — InDesign ExtendScript Journey
...
- Cabeçalhos padrão para scripts `.jsx`
- Estrutura base de arquivos para aulas
- Snippets reutilizáveis (criação de documentos, páginas, frames, logs)
- Modelos organizacionais para manter consistência no código
...
- **snippets/**  
Scripts pequenos e reutilizáveis para tarefas comuns (criação de documentos, frames, logs, etc.).
...
Sinta-se à vontade para explorar, reutilizar e sugerir melhorias nestes templates ao longo da sua jornada 🚀
